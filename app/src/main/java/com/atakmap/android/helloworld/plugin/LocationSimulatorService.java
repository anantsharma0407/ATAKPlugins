...
/**
 * Background service that simulates location updates
 * Supports multiple modes: static, jitter, route (circle), and square
 *
 * This service uses a singleton pattern to allow plugin components
 * to communicate with it without requiring service binding.
 */
public class LocationSimulatorService extends Service {

    private static final String TAG = "LocationSimulatorService";

    // Singleton instance for direct access
    private static LocationSimulatorService instance;
     ...
     */
    public static LocationSimulatorService getInstance() {
        return instance;
    }
    ...
    public IBinder onBind(Intent intent) {
        // We're not using binding, return null
        return null;
    }
